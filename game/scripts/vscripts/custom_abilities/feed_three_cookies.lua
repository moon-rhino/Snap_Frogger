...
--------------------------------------------------------------------------------
-- Ability Phase Start
function feed_three_cookies:OnAbilityPhaseInterrupted()
end

function feed_three_cookies:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Ability Start
function feed_three_cookies:OnSpellStart()
    ...
    --after a delay, third
    Timers:CreateTimer(string.format("feed_third_cookie_%s", self.caster:GetPlayerID()), {
        useGameTime = false,
        endTime = 1,
        callback = function()
            if self.caster:IsAlive() then
...
--------------------------------------------------------------------------------
-- Projectile
function feed_three_cookies:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function feed_three_cookies:PlayEffects1()
	-- Get Resources
...
function feed_three_cookies:PlayEffects2( target )
	-- Get Resources
...
function feed_three_cookies:PlayEffects3( target, radius )
	-- Get Resources
