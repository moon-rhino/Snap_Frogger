...
function shoot_cookie_3:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_3:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_3:PlayEffects3( target, radius )
	-- Get Resources
