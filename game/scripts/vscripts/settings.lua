...
PRE_GAME_TIME = 2            -- How long after people select their heroes should the horn blow and the game start?
...
FIXED_RESPAWN_TIME = 2                 -- What time should we use for a fixed respawn timer?  Use -1 to keep the default dota behavior.
...
STARTING_GOLD = 100                  -- How much starting gold should we give to each player?
...
TEAM_COLORS[DOTA_TEAM_CUSTOM_1] = { 0, 255, 255 }  --    Aqua (hard to read blue)
...
TEAM_COLORS[DOTA_TEAM_CUSTOM_6] = { 255, 165, 0 }  --    Orange (cyan looks like aqua)
TEAM_COLORS[DOTA_TEAM_CUSTOM_7] = { 245, 245, 220 }  --    Beige
