...
function invoker_ice_wall_datadriven_on_spell_start(keys)
	...
	--Vector(300, target_point.y - vector_distance_from_center.y, target_point.z - vector_distance_from_center.z)
	...
	local quas_ability = keys.caster:FindAbilityByName("invoker_quas")
	...
	local exort_ability = keys.caster:FindAbilityByName("invoker_exort")
	local exort_level = 1
