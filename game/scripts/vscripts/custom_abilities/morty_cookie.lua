...
--------------------------------------------------------------------------------
-- Custom KV
function morty_cookie:GetCastPoint()
    if IsServer() then
        self:GetCaster():EmitSound("cowabunga")
...
--------------------------------------------------------------------------------
-- Ability Phase Start
function morty_cookie:OnAbilityPhaseInterrupted()

end
function morty_cookie:OnAbilityPhaseStart()
    if IsServer() then
...
--------------------------------------------------------------------------------
-- Ability Start
function morty_cookie:OnSpellStart()
    if IsServer() then
        -- unit identifier
...
--------------------------------------------------------------------------------
function morty_cookie:PlayEffects1()
	-- Get Resources
...
function morty_cookie:PlayEffects2( target )
	-- Get Resources
...
function morty_cookie:PlayEffects3( target, radius )
	-- Get Resources
...
--------------------------------------------------------------------------------
function morty_cookie:PlayEffectsKisses( loc, owner )
	-- Get Resources
...
--------------------------------------------------------------------------------
function morty_cookie:PlayEffectsCalldown( time, owner )
	-- Get Resources
