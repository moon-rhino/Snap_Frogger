...
function shoot_cookie_4:OnSpellStart()
    if IsServer() then
        ...
        { 
            Ability = self,
            EffectName = "particles/hero_snapfire_cookie_projectile_linear_big.vpcf", --particle effect
...
function shoot_cookie_4:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_4:PlayEffects3( target, radius )
	-- Get Resources
