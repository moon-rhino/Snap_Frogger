...
local SHOOT_SPEED = 1100
function shoot_cookie_medium:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_medium:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_medium:PlayEffects3( target, radius )
	-- Get Resources
