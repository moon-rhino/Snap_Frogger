...
function shoot_cookie_1:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_1:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_1:PlayEffects3( target, radius )
	-- Get Resources
