...
function shoot_cookie_slow:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_slow:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_slow:PlayEffects3( target, radius )
	-- Get Resources
