...
--------------------------------------------------------------------------------
cookie_no_damage_with_cooldown = class({})
...
--------------------------------------------------------------------------------
-- Custom KV
function cookie_no_damage_with_cooldown:GetCastPoint()
...
--------------------------------------------------------------------------------
-- Ability Cast Filter
function cookie_no_damage_with_cooldown:CastFilterResultTarget( hTarget )
...
function cookie_no_damage_with_cooldown:GetCustomCastErrorTarget( hTarget )
	if IsServer() and hTarget:IsChanneling() then
...
--------------------------------------------------------------------------------
-- Ability Phase Start
function cookie_no_damage_with_cooldown:OnAbilityPhaseInterrupted()

end
function cookie_no_damage_with_cooldown:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Ability Start
function cookie_no_damage_with_cooldown:OnSpellStart()
...
--------------------------------------------------------------------------------
-- Projectile
function cookie_no_damage_with_cooldown:OnProjectileHit( target, location )
    --cast on enemy
    --jump in place
...
--------------------------------------------------------------------------------
function cookie_no_damage_with_cooldown:PlayEffects1()
	-- Get Resources
...
function cookie_no_damage_with_cooldown:PlayEffects2( target )
	-- Get Resources
...
function cookie_no_damage_with_cooldown:PlayEffects3( target, radius )
	-- Get Resources
