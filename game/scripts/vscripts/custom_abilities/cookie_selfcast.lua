...
--------------------------------------------------------------------------------
-- Ability Cast Filter
function cookie_selfcast:CastFilterResultTarget( hTarget )
...
function cookie_selfcast:GetCustomCastErrorTarget( hTarget )
	if IsServer() and hTarget:IsChanneling() then
...
--------------------------------------------------------------------------------
-- Ability Phase Start
function cookie_selfcast:OnAbilityPhaseInterrupted()

end
function cookie_selfcast:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Ability Start
function cookie_selfcast:OnSpellStart()
...
--------------------------------------------------------------------------------
-- Projectile
function cookie_selfcast:OnProjectileHit( target, location )
    --cast on friend
    --jump
...
--------------------------------------------------------------------------------
function cookie_selfcast:PlayEffects1()
	-- Get Resources
...
function cookie_selfcast:PlayEffects2( target )
	-- Get Resources
...
function cookie_selfcast:PlayEffects3( target, radius )
	-- Get Resources
...
--------------------------------------------------------------------------------
function cookie_selfcast:PlayEffectsKisses( loc, owner )
	-- Get Resources
...
--------------------------------------------------------------------------------
function cookie_selfcast:PlayEffectsCalldown( time, owner )
	-- Get Resources
