...
function shoot_cookie_5:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_5:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_5:PlayEffects3( target, radius )
	-- Get Resources
