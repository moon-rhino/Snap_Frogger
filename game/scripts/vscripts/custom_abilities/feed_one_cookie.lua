...
--------------------------------------------------------------------------------
-- Ability Phase Start
function feed_one_cookie:OnAbilityPhaseInterrupted()
end

function feed_one_cookie:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Ability Start
function feed_one_cookie:OnSpellStart()
...
--------------------------------------------------------------------------------
-- Projectile
function feed_one_cookie:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function feed_one_cookie:PlayEffects1()
	-- Get Resources
...
function feed_one_cookie:PlayEffects2( target )
	-- Get Resources
...
function feed_one_cookie:PlayEffects3( target, radius )
	-- Get Resources
