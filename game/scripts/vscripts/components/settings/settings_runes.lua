...
if IMBA_MUTATION and IMBA_MUTATION["terrain"] == "super_runes" then
	...
	IMBA_RUNE_ARCANE_MANA_COST_REDUCTION = 50 -- %
	IMBA_RUNE_ARCANE_MANA_CAST_TIME_PCT = 50 -- %

	-- Double Damage
	IMBA_RUNE_DOUBLE_DAMAGE_MULTIPLIER = 1.5 -- 150% damage
	...
	-- Double Damage
	--adjust this, not the one above
	IMBA_RUNE_DOUBLE_DAMAGE_MULTIPLIER = 0.5 -- 200% damage, attribute 20%
