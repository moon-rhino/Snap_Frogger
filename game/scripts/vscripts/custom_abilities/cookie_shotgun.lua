...
--------------------------------------------------------------------------------
-- Custom KV
function cookie_shotgun:GetCastPoint()
...
--------------------------------------------------------------------------------
-- Ability Cast Filter
function cookie_shotgun:CastFilterResultTarget( hTarget )
...
function cookie_shotgun:GetCustomCastErrorTarget( hTarget )
	if IsServer() and hTarget:IsChanneling() then
...
--------------------------------------------------------------------------------
-- Ability Phase Start
function cookie_shotgun:OnAbilityPhaseInterrupted()

end
function cookie_shotgun:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Ability Start
function cookie_shotgun:OnSpellStart()
...
--------------------------------------------------------------------------------
-- Projectile
function cookie_shotgun:OnProjectileHit( target, location )
    --cast on friend
    --jump
...
--------------------------------------------------------------------------------
function cookie_shotgun:PlayEffects1()
	-- Get Resources
...
function cookie_shotgun:PlayEffects2( target )
	-- Get Resources
...
function cookie_shotgun:PlayEffects3( target, radius )
	-- Get Resources
...
--------------------------------------------------------------------------------
function cookie_shotgun:PlayEffectsKisses( loc, owner )
	-- Get Resources
...
--------------------------------------------------------------------------------
function cookie_shotgun:PlayEffectsCalldown( time, owner )
	-- Get Resources
...
--------------------------------------------------------------------------------
function cookie_shotgun:PlayInvulnerableEffect()
