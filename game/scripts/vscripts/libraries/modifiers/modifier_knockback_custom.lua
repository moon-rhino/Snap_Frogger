...
-- See the reference at https://github.com/Elfansoer/dota-2-lua-abilities/blob/master/scripts/vscripts/lua_abilities/generic/modifier_generic_knockback_lua.lua

modifier_knockback_custom = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_knockback_custom:IsHidden()
	return true
end

function modifier_knockback_custom:IsPurgable()
	return false
end

function modifier_knockback_custom:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_knockback_custom:OnCreated( kv )
	if IsServer() then
...
function modifier_knockback_custom:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_knockback_custom:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function modifier_knockback_custom:SetEndCallback( func ) 
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_knockback_custom:DeclareFunctions()
	local funcs = {
...
function modifier_knockback_custom:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_knockback_custom:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_knockback_custom:UpdateHorizontalMotion( me, dt )
...
function modifier_knockback_custom:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_knockback_custom:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_knockback_custom:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_knockback_custom:GetEffectName()
	if not IsServer() then return end
	if self.stun then
...
function modifier_knockback_custom:GetEffectAttachType()
	if not IsServer() then return end
