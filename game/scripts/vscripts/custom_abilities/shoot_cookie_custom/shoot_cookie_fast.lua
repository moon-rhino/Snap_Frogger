...
local SHOOT_SPEED = 1400
function shoot_cookie_fast:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_fast:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_fast:PlayEffects3( target, radius )
	-- Get Resources
