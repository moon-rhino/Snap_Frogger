...
--------------------------------------------------------------------------------
-- Ability Cast Filter
function jump:CastFilterResultTarget( hTarget )
...
function jump:GetCustomCastErrorTarget( hTarget )
	if IsServer() and hTarget:IsChanneling() then
...
--------------------------------------------------------------------------------
-- Ability Phase Start
function jump:OnAbilityPhaseInterrupted()

end
function jump:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Projectile
function jump:OnProjectileHit( target, location )
...
function jump:PlayEffects2( target )
	-- Get Resources
...
function jump:PlayEffects3( target, radius )
	-- Get Resources
