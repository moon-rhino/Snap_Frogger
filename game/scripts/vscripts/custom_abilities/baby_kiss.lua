...
LinkLuaModifier( "baby_kiss_modifier", "custom_abilities/baby_kiss", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "baby_kiss_thinker_modifier", "custom_abilities/baby_kiss", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "magma_burn_slow_modifier", "custom_abilities/baby_kiss", LUA_MODIFIER_MOTION_NONE )


--------------------------------------------------------------------------------
-- Custom KV
-- AOE Radius
function baby_kiss:GetAOERadius()
	return self:GetSpecialValueFor( "impact_radius" )
end

--------------------------------------------------------------------------------
-- Ability Start
function baby_kiss:OnSpellStart()
	-- unit identifier
	...
	caster:AddNewModifier(
		...
		self, -- ability source
		"baby_kiss_modifier", -- modifier name
		{
			duration = duration,
			pos_x = point.x,
			pos_y = point.y,
...
--------------------------------------------------------------------------------
-- Projectile
function baby_kiss:OnProjectileHit( target, location )
	...
	local mod = target:AddNewModifier(
		...
		self, -- ability source
		"baby_kiss_thinker_modifier", -- modifier name
		{
			duration = duration,
			slow = 1,
		} -- kv
	...
	-- create Vision
	AddFOWViewer( self:GetCaster():GetTeam(), location, vision, duration, false )
...
--aura 
--------------------------------------------------------------------------------
function baby_kiss:PlayEffects( loc )
	-- Get Resources
	local particle_cast = "particles/hero_snapfire_ultimate_impact_custom.vpcf"
	local particle_cast2 = "particles/hero_snapfire_ultimate_linger_baby.vpcf"
...
--------------------------------------------------------------------------------
baby_kiss_modifier = class({})

--------------------------------------------------------------------------------
-- Classifications
function baby_kiss_modifier:IsHidden()
	return false
end

function baby_kiss_modifier:IsDebuff()
	return false
end

function baby_kiss_modifier:IsStunDebuff()
	return false
end

function baby_kiss_modifier:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function baby_kiss_modifier:OnCreated( kv )
	-- references
...
function baby_kiss_modifier:OnRefresh( kv )
	
end

function baby_kiss_modifier:OnRemoved()
end

function baby_kiss_modifier:OnDestroy()
end

--------------------------------------------------------------------------------
-- Modifier Effects
function baby_kiss_modifier:DeclareFunctions()
	local funcs = {
...
function baby_kiss_modifier:OnOrder( params )
...
function baby_kiss_modifier:GetModifierMoveSpeed_Limit()
	return 0.1
end

function baby_kiss_modifier:GetModifierTurnRate_Percentage()
	return -self.turn_rate
end

--------------------------------------------------------------------------------
-- Status Effects
function baby_kiss_modifier:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function baby_kiss_modifier:OnIntervalThink()
	self:CreateBlob(kv)
end

function baby_kiss_modifier:CreateBlob(kv)
...
--------------------------------------------------------------------------------
-- Helper
function baby_kiss_modifier:SetValidTarget( location )
...
--------------------------------------------------------------------------------
baby_kiss_thinker_modifier = class({})
...
--------------------------------------------------------------------------------
-- Initializations
function baby_kiss_thinker_modifier:OnCreated( kv )
	-- references
	self.max_travel = self:GetAbility():GetSpecialValueFor( "max_lob_travel_time" )
    ...
    if self:GetAbility():GetAbilityName() == "baby_kiss" then
        --self:PlayEffects( kv.travel_time )
    end
end

function baby_kiss_thinker_modifier:OnRefresh( kv )
	-- references
	self.max_travel = self:GetAbility():GetSpecialValueFor( "max_lob_travel_time" )
	self.radius = self:GetAbility():GetSpecialValueFor( "impact_radius" )
	self.linger = self:GetAbility():GetSpecialValueFor( "burn_linger_duration" )
...
function baby_kiss_thinker_modifier:OnRemoved()
end

function baby_kiss_thinker_modifier:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Aura Effects
function baby_kiss_thinker_modifier:IsAura()
	return self.start
end

function baby_kiss_thinker_modifier:GetModifierAura()
	return "magma_burn_slow_modifier"
end

function baby_kiss_thinker_modifier:GetAuraRadius()
	return self.radius
end

function baby_kiss_thinker_modifier:GetAuraDuration()
	return self.linger
end

function baby_kiss_thinker_modifier:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end

function baby_kiss_thinker_modifier:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

--[[function baby_kiss_thinker_modifier:PlayEffects( time )
	-- Get Resources
...
--[[function baby_kiss_thinker_modifier:StopEffects()
