...
function slug:OnAbilityPhaseStart()
...
function slug:OnProjectileHit(hTarget, vLocation)
    if hTarget == nil then
        --table value stays on even after the end of the spell
