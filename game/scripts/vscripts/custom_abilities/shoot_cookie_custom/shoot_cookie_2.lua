...
function shoot_cookie_2:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_2:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_2:PlayEffects3( target, radius )
	-- Get Resources
