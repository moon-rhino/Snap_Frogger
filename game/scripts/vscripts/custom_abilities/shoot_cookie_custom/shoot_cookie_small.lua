...
function shoot_cookie_small:OnSpellStart()
    if IsServer() then
...
function shoot_cookie_small:OnProjectileHit(hTarget, vLocation)
...
function shoot_cookie_small:PlayEffects3( target, radius )
	-- Get Resources
